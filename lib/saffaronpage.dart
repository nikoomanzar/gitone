...
class saffronpage extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return saffronpagestate();
    throw UnimplementedError();
  }

}
class saffronpagestate extends State<saffronpage>{
            ...
            children: [
              ...
              Padding(padding: EdgeInsets.only(left: devicesize.width*0.08),child: new Row(
                children: [
                  ...
                  ,SizedBox(height: devicesize.height*0.31,width: 260,child: Image(image: AssetImage("assets/images/sf.png"),),
                  )],
              ),),
              ...
              Row(children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Padding(padding: EdgeInsets.only(left: devicesize.width*0.06,bottom: 5),child: Container(width:90,height:100 ,decoration: BoxDecoration(
